...
Find any time where `as_of` was not a Wednesday or the difference between `as_of` and `max_date` was not 4 days:
```{r}
...
`2024-11-22` and `2024-11-18` will be removed becasue we have `as_of` `2024-11-20`:
